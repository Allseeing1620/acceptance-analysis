...
def plot_primary_lambda_decay_z_distribution(df_primary):
...
def plot_decay_trajectories(p_pi_minus_decays):
...
def plot_neutron_pizero_decay_trajectories(n_pi_zero_decays):
...
def plot_primary_vs_secondary_decay_points(df_primary, df_secondary):
...
def plot_primary_vs_secondary_birth_points(df_primary, df_secondary):
...
def main():
    ...
    # results_dir = save_all_plots(
    #     decay_modes,
    #     output_dir="C:/Users/User/Desktop/test/my_analysis_results"
    # )
